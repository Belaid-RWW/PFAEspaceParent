...
urlpatterns = [
    ...
    path('teacher_marks', views.teacher_marks_view,name='teacher_marks'),
    path('teacher_add_marks', views.AddMark, name='teacher_add_marks'),
    path('teacher_marks_view', views.teacher_marks_viewing,name='teacher_marks_view'),
    path('teacher_update_marks/<str:pk>/', views.updateMark, name='teacher_update_marks'),
    path('teacher_delete_marks/<str:pk>/', views.deleteMark, name='teacher_delete_marks'),


    path('admin_punitions', views.admin_punitions_view,name='admin_punitions'),
    path('admin_add_punitions', views.AddPunition,name='admin_add_punitions'),
    path('admin_punitions_view', views.admin_punitions_viewing,name='admin_punitions_view'),
    path('admin_update_punitions/<str:pk>/', views.updatePunition, name='admin_update_punitions'),
    path('admin_delete_punitions/<str:pk>/', views.deletePunition, name='admin_delete_punitions'),


    path('admin_emplois', views.admin_emplois_view,name='admin_emplois'),
    path('admin_add_emplois', views.AddEmploi,name='admin_add_emplois'),
    path('admin_emplois_view', views.admin_emplois_viewing,name='admin_emplois_view'),
    path('admin_update_emplois/<str:pk>/', views.updateEmploi, name='admin_update_emplois'),
    path('admin_delete_emplois/<str:pk>/', views.deleteEmploi, name='admin_delete_emplois'),
